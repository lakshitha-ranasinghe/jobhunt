 ...
 * @author Lakshitha
 */
public class OpenProfessionalProfile extends ActionSupport {
    ...
    public OpenProfessionalProfile() {
    }
    ...
    public String execute() throws Exception {
        ...
        workedCompanies = (List)jobseeker.getJobseekerWorkedcompanyCollection();
        otherQualifications = (List)jobseeker.getJobseekerOtherCollection();
        experience = (JobseekerExperience)((List)jobseeker.getJobseekerExperienceCollection()).get(FIRSTRESULT);
        return SUCCESS;
    }
